  ...
  <div class="dashboard-container">
    <el-row>
      ...
      <el-col :span="24">
        <div class="xiangqing">
          <div>
            <a-card title="Card title" :bordered="true" style="width: 1380px">
      ...
      <el-col :span="12">
        <div style="background: #ececec; padding: 30px">
          <a-card title="消息" :bordered="true" style="width: 690px">
      ...
      <el-col :span="12">
        <div style="padding: 30px">
          <a-card title="考勤率" :bordered="false" style="width: 645px">
